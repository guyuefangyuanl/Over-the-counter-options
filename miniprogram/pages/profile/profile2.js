...
Page({
  ...
  isPageExists: function(path) {
    const existingPages = [
      ...
      // 分包页面（按 app.json 中的实际路径）
      '/subpackages/tools/calculator/calculator',
      '/subpackages/tools/chart/chart',
      '/subpackages/tools/option-matrix/option-matrix',
      '/subpackages/tools/workspace/workspace',
      '/subpackages/tools/workbench/workbench',
      '/subpackages/tools/data-explanation/data-explanation',
      '/subpackages/user/feedback/feedback',
      '/subpackages/user/position/position',
      '/subpackages/user/member/member',
      '/subpackages/user/inquiry-history/inquiry-history',
      '/subpackages/user/orders/orders',
      '/subpackages/user/user-info/user-info',
      '/subpackages/agreement/user-agreement/user-agreement',
      '/subpackages/agreement/privacy-policy/privacy-policy',
      '/subpackages/inquiry/inquiry/inquiry',
      '/subpackages/inquiry/detail/detail',
      '/subpackages/quotes/search/search',
      '/subpackages/quotes/search-stock/search-stock',
      '/subpackages/quotes/stock-detail/stock-detail',
      '/subpackages/info/knowledge/knowledge',
      '/subpackages/info/news/news'
    ];
